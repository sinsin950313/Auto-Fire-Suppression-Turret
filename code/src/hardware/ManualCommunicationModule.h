...
class ManualCommunicationModule : public CommunicationModule
{
    public:
	ManualCommunicationModule(TypeList ht, char myAddress = CENTRAL_ADDRESS);

	~ManualCommunicationModule() override;
